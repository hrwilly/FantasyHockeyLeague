...
def get_my_team_players():
    return players[players["drafted_by"] == selected_team].copy()

my_team_players = get_my_team_players()

# --- Count drafted players for roster validation ---
...
if st.button("Draft Player", key="draft_player_button"):
    ...
    players.loc[idx, "Pick_Number"] = int(st.session_state.pick_number)
    ...
    # Reload my team players immediately
    my_team_players = get_my_team_players()
