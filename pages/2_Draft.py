...
st_autorefresh(interval=100000, key="draft_autorefresh")
...
st.session_state["team_name"] = st.selectbox(
    "Select your team:",
    ['Terrier Town', 'Take a Lachance on me', 'What the Helena', 'Bring back the Thrashers', 'Meth Rhett', 'Zeev Buium', 'HYHusky', 'Team G', 'All Aboard the Cole Train', 'Puck Stops Here', 'LaSoiréeDuHockeyMolson', 'Mike is gonna Ryder Dyck']
)
...
if can_draft:
    ...
    if st.button("Draft Player", key="draft_player_button"):
        ...
        db_utils.save_player(players[['Name', 'team', 'Yr.', 'Pos.', 'Ht.', 'Wt.', 'YOB', 'Hometown', 'Last Team', 'Draft Year', 'Draft Team', 'Draft Round', 'held_by']].loc[idx_players].iloc[0])
