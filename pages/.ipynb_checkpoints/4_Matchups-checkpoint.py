...
with col1:
    ...
    st.caption("Starters")
    st.dataframe(team1_starters[["player_name", "Pos.", 'points']], hide_index=True, height = 500)
    st.divider()
    st.caption("Bench")
...
with col2:
    st.markdown(f"### Lineup")
    st.caption("Starters")
    st.dataframe(team2_starters[["player_name", "Pos.", 'points']], hide_index=True, height = 500)
    st.divider()
    st.caption("Bench")
